...
defmodule AutoApi.DoorsTest do
  ...
  describe "execute/2" do
    ...
    test "lock_unlock_doors unlock command" do
      command = DoorsCommand.to_bin(:lock_unlock_doors, lock_state: :unlock)
